        ...
        <Container className="col ">
          ...
          <Navbar.Collapse id="responsive-navbar-nav">
            <Nav className="ms-auto">
              ...
              <Nav.Link href="#"><Link className="text-white text-decoration-none" to="/Login" onClick={e=>setIsSignedUp(true)}>LogIn</Link></Nav.Link>
              <Nav.Link href="#"><Link className="text-white text-decoration-none" to="/SignUp" onClick={e=>setIsSignedUp(false)}>SignUp</Link></Nav.Link>
            </Nav>
          </Navbar.Collapse>
        </Container>
      </Navbar>
